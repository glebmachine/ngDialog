                ...
                var publicMethods = {
                    ...
                    open: function (opts) {
                        ...
                        $q.all({
                            ...
                            template =
                                '<div class="ngdialog-center"><div class="ngdialog-center-row"><div class="ngdialog-center-cell">'
                                + (options.overlay ? '<div class="ngdialog-overlay"></div>' : '')
                                + '<div class="ngdialog-content" role="document">'+template+'</div></div></div></div>';
